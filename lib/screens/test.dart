...
class GillsPage extends StatefulWidget {
  GillsPage(
      {Key? key,
  ...
  @override
  State<GillsPage> createState() => _GillsPageState();
}

class _GillsPageState extends State<GillsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('GILLS Model')),
      ),
      body: Column(
